 ...
 */
function calculateHealthScore(product: any): { score: number; color: string; label: string; reasons: string[] } {
  ...
  if (score >= 80) { color = "#22c55e"; label = "Excellent"; }       // green
  else if (score >= 65) { color = "#84cc16"; label = "Good"; }       // lime
  else if (score >= 50) { color = "#eab308"; label = "Average"; }    // yellow
  else if (score >= 35) { color = "#f97316"; label = "Below Average"; } // orange
  else { color = "#ef4444"; label = "Poor"; }                        // red

  // Only show top 4 most impactful reasons
